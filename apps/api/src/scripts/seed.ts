...
const events = [
  {
    ...
    districtId: ids.districts.montmartre,
    title: "Nettoyage du quartier",
    description: "Nettoyons ensemble la Place du Tertre et les rues alentour. Sacs et gants fournis.",
  ...
  },
  {
    ...
    districtId: ids.districts.marais,
    title: "Barbecue d'été dans la cour",
    description:
      "Barbecue ouvert à tous les habitants de l'immeuble et aux voisins. Apportez quelque chose à partager.",
    location: "Cour, 5 Rue des Rosiers",
    totalSeats: 30,
    remainingSeats: 28,
    status: "upcoming",
  ...
  },
  {
    ...
    districtId: ids.districts.marais,
    title: "Atelier repair café bricolage",
    description: "Apportez vos petits appareils ou vêtements abîmés — on les répare ensemble.",
    location: "Salle communale, 22 Rue Vieille du Temple",
    totalSeats: 15,
    remainingSeats: 15,
    status: "upcoming",
    registrants: [],
...
const incidents = [
  {
    ...
    districtId: ids.districts.montmartre,
    category: "lighting",
    description: "Le lampadaire de la Rue Lepic est en panne depuis 3 jours.",
    status: "in_progress",
    history: [
      { status: "open", updatedBy: ids.users.alice, updatedAt: lastWeek },
      {
        status: "in_progress",
        note: "Services municipaux contactés",
  ...
  },
  {
    ...
    districtId: ids.districts.marais,
    category: "vandalism",
    description: "Graffiti sur le mur de l'aire de jeux.",
  ...
  },
  {
    ...
    description: "Poubelles qui débordent au coin de la Rue des Abbesses.",
    status: "resolved",
    history: [
      { status: "open", updatedBy: ids.users.bob, updatedAt: lastWeek },
      {
        status: "resolved",
        note: "Poubelles vidées par la ville",
        updatedBy: ids.users.admin,
        updatedAt: now,
      },
    ],
...
const votes = [
  {
    ...
    question: "Faut-il transformer le parking de la Rue des Abbesses en parc de quartier ?",
  ...
  },
  {
    ...
    question: "Quel jour organiser le marché hebdomadaire du quartier ?",
...
const conversations = [
  ...
  },
  {
    ...
    districtId: ids.districts.montmartre,
    type: "group",
    name: "Organisateurs du nettoyage",
    lastMessageAt: now,
    createdAt: lastWeek,
  },
];
...
const messages = [
  {
    ...
    districtId: ids.districts.montmartre,
    type: "text",
    content: "Salut Bob, tu es dispo samedi pour la réparation de plomberie ?",
    read: true,
    createdAt: lastWeek,
  },
  {
    ...
    districtId: ids.districts.montmartre,
    type: "text",
    content: "Oui, je peux passer vers 10h. Je t'envoie le contrat.",
    read: false,
    createdAt: now,
  },
  {
    ...
    districtId: ids.districts.montmartre,
    type: "text",
    content: "Salut à tous, les gants et les sacs sont prêts pour le nettoyage de la semaine prochaine !",
    read: true,
    createdAt: lastWeek,
  },
  {
    ...
    districtId: ids.districts.montmartre,
    type: "text",
    content: "Super, je peux apporter des sacs poubelle en plus.",
    read: false,
    createdAt: now,
  },
];
...
const notifications = [
  {
    ...
    type: "system",
    title: "Bienvenue sur Connected Neighbours",
    message: "Votre compte est prêt. Explorez les annonces autour de vous !",
    read: true,
    createdAt: lastWeek,
  },
  {
    ...
    type: "event",
    title: "Rappel : barbecue demain",
    message: "N'oubliez pas le barbecue d'été demain à 19h.",
  ...
  },
  {
    ...
    message: "Le vote sur le marché hebdomadaire du quartier est maintenant ouvert.",
  ...
  },
  {
    ...
    message: "Charlie a signalé un graffiti sur le mur de l'aire de jeux.",
