...
const Evenement = () => {
  ...
  // Quand un user s'inscrit / clique 👍, on rafraîchit les deux listes :
  // les inscriptions changent la liste principale, et les nouveaux signaux
  // d'intérêt peuvent modifier les recommandations.
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      {/* Section "Pour toi" — recommandations Neo4j */}
      {user?.id && (
        <div style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, margin: "0 0 12px 0" }}>
            🎯 Pour toi
          </h2>
          {recoLoading ? (
