...
| Area                                          | State                                                                                                                                                                                                                                                         | Evidence                                                                              |
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| **auth-service** (`apps/auth-service`, :6000) | **Complete** and matches `documentation/auth-service.md`. RS256/JWKS, argon2, refresh rotation (sha256-hashed, httpOnly cookie scoped `/auth`), email verification, password reset, TOTP/MFA enroll·confirm·disable, self-hosted `/login` + `/register` HTML. | `routes/auth/auth.router.ts`, `use-cases/*`, `keys.ts`, `index.ts:73-80`              |
...
- Assign the **port** (TBD in doc; taken: api 3000, admin 4000, user 5000, auth 6000, neo4j 7474) and register in `docker-compose*.yml` + `turbo.json`.
