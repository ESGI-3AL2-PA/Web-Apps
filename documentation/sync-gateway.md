...
> **Port TBD** — must be assigned before the service is added to `docker-compose.yml` / `docker-compose.deploy.yml` and `turbo.json`. Other services: api 3000, admin-front 4000, user-front 5000, auth-service 3001.
